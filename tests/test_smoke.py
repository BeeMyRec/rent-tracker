...
from rent_tracker.cli import main
from rent_tracker.models import Note, ProjectState, Task
from rent_tracker.cli import demo_state
from rent_tracker.storage import load_state, save_state
from rent_tracker.models import generate_short_id
from rent_tracker.validation import normalize_tags, require_text, validate_task_status
from rent_tracker.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
